...
/**
 * This custom version of the CollapsingBarLayout allows setting scrim thresholds by
 * calling setScrimTriggerOffset() or setScrimTriggerOffsetMultiplie().
 *
...
public class CustomCollapsingToolbarLayout extends FrameLayout {
    ...
    private int scrimTriggerOffset = -1;
     ...
     */
    protected int getScrimTriggerOffset() {
        if (scrimTriggerOffset < 0)
            scrimTriggerOffset = (int) (1.5 * ViewCompat.getMinimumHeight(this));
        return scrimTriggerOffset;
    }

    public void setScrimTriggerOffsetMultiplier(float scrimTriggerOffsetMultiplier) {
        scrimTriggerOffset =
                (int) (scrimTriggerOffsetMultiplier * ViewCompat.getMinimumHeight(this));
    }

    public void setScrimTriggerOffset(int scrimTriggerOffset) {
        this.scrimTriggerOffset = scrimTriggerOffset;
    }
    ...
    private class OffsetUpdateListener implements AppBarLayout.OnOffsetChangedListener {
        ...
        public void onOffsetChanged(AppBarLayout layout, int verticalOffset) {
            ...
            if (Math.abs(verticalOffset) == scrollRange) {
                ...
                ViewCompat.setElevation(layout, 0f);//layout.getTargetElevation());
            } else {
