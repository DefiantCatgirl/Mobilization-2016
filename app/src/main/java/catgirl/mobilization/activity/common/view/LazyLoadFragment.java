...
import catgirl.mobilization.tools.AutofitStaggeredRecyclerView;
...
public abstract class LazyLoadFragment<T, P extends Presenter, C>
    ...
    @Bind(R.id.Recycler) public AutofitStaggeredRecyclerView recyclerView;
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        ViewGroup view = (ViewGroup) inflater.inflate(getLayoutResource(), container, false);
        ...
        RecyclerView.Adapter<RecyclerView.ViewHolder> adapter = new RecyclerView.Adapter<RecyclerView.ViewHolder>() {
            ...
            public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
                switch (viewType) {
                    ...
                    default:
                        return LazyLoadFragment.this.createViewHolder(parent, viewType);
                }
            }
            ...
            public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
                ...
                if ((mode == LOADING || mode == ERROR) && position == getItemCount() - 1) {
            ...
            public int getItemViewType(int position) {
                if (position == getItemCount() - 1) {
                    ...
                    return LazyLoadFragment.this.getItemViewType(position);
                }
            }
        ...
        if (getSpanCount() > 0) {
            ((StaggeredGridLayoutManager) recyclerView.getLayoutManager()).setSpanCount(getSpanCount());
            recyclerView.columnWidth = -1;
        }
    ...
    protected abstract boolean hasStableIds();
    ...
    protected void testScrollUpwards() {
        boolean shouldScrollUpwards = ((StaggeredGridLayoutManager) recyclerView.getLayoutManager())
